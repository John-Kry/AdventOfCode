...
namespace AdventOfCode.Tasks.Year2021.Day05
{
        ...
        public int Solution(string input)
        {
            ...
            foreach (var line in lines)
            {
                ...
                if (line.startPosition.x != line.endPosition.x && line.startPosition.y != line.endPosition.y)
                {
                    ...
                    {
                        var temp = new Position {x = line.endPosition.x, y = line.endPosition.y};
                        line.endPosition = line.startPosition;
                        line.startPosition = temp;
                    }

                    //diagonal up
                    if (line.startPosition.y > line.endPosition.y)
                    {
                        for (var i = 0; i <= Math.Abs(line.startPosition.x - line.endPosition.x); i++)
                        {
